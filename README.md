# COVID-19 / Δεδομένα για την Ελλάδα

Σε αυτό το project κάνουμε μια προσπάθεια καταγραφής των σχετικών αναφορών, δεδομένω και πηγών δεδομένων που ασχολούνται με την καταγραφή της εξέλιξης της πανδημίας του SARS-COV-2 στην Ελλάδα. Η καταγραφή γίνεται για λόγους αρχειοθέτησης κυρίως.
